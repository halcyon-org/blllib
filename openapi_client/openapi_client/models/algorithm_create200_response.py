...
class AlgorithmCreate200Response(BaseModel):
    ...
    api_key: StrictStr
    __properties: ClassVar[List[str]] = ["algorithm_id", "algorithm_name", "algorithm_description", "need_external", "algorithm_scales", "algorithm_data_ids", "version", "first_entry_at", "last_entry_at", "last_updated_at", "api_key"]
