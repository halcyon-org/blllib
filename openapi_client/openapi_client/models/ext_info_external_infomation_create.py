...
class ExtInfoExternalInfomationCreate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["external_name", "external_description", "license", "license_description", "first_entry_at", "last_updated_at", "updated_history"]
