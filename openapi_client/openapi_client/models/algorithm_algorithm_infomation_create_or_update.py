...
class AlgorithmAlgorithmInfomationCreateOrUpdate(BaseModel):
    """
    ...
    algorithm_params: Dict[str, StrictStr] = Field(description="param name: param default")
    ...
    __properties: ClassVar[List[str]] = ["algorithm_id", "algorithm_name", "algorithm_description", "need_external", "algorithm_params", "algorithm_scales", "algorithm_data_ids", "version"]
