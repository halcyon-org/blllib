...
class AlgorithmAlgorithmInfomation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["algorithm_id", "algorithm_name", "algorithm_description", "need_external", "algorithm_params", "algorithm_scales", "algorithm_data_ids", "version", "first_entry_at", "last_entry_at", "last_updated_at"]
