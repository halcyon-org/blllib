...
class EachKoyoDataNewRequest(BaseModel):
    """
    EachKoyoDataNewRequest
    """ # noqa: E501
    update_data: KoyoKoyoDataCreateOrUpdate
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "update_data": KoyoKoyoDataCreateOrUpdate.from_dict(obj["update_data"]) if obj.get("update_data") is not None else None
        })
        return _obj
