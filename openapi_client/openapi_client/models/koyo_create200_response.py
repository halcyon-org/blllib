...
class KoyoCreate200Response(BaseModel):
    """
    KoyoCreate200Response
    """ # noqa: E501
    koyo_id: Annotated[str, Field(strict=True)] = Field(description="This ID can be obtained through admin api. It is a human friendly format like GitHub repository names. Only the pattern `^[a-z_-]{1,64}$` is allowed.")
    ...
    api_key: StrictStr
    __properties: ClassVar[List[str]] = ["koyo_id", "koyo_name", "koyo_description", "need_external", "koyo_params", "koyo_scales", "koyo_data_ids", "version", "license", "ext_licenses", "first_entry_at", "last_entry_at", "last_updated_at", "api_key"]
