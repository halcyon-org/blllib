...
class ExtInfoExampleInfoExampleData(BaseModel):
    """
    ExtInfoExampleInfoExampleData
    """ # noqa: E501
    area: TypesGeoJSONMultiPolygon
    image: Union[StrictBytes, StrictStr]
    __properties: ClassVar[List[str]] = ["area", "image"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "area": TypesGeoJSONMultiPolygon.from_dict(obj["area"]) if obj.get("area") is not None else None,
            "image": obj.get("image")
        })
        return _obj
