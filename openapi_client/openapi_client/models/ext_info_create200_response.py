...
class ExtInfoCreate200Response(BaseModel):
    ...
    api_key: StrictStr
    __properties: ClassVar[List[str]] = ["external_id", "external_name", "external_description", "license", "license_description", "first_entry_at", "last_updated_at", "updated_history", "api_key"]
