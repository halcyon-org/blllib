...
class KoyoKoyoInfomationCreateOrUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["koyo_id", "koyo_name", "koyo_description", "need_external", "koyo_params", "koyo_scales", "koyo_data_ids", "version", "license", "ext_licenses"]
