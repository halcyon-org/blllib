...
from blllib import ExtInfoExternalInfomationCreate
...
class TestExtInfoExternalInfomationCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExtInfoExternalInfomationCreate:
        """Test ExtInfoExternalInfomationCreate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtInfoExternalInfomationCreate`
        """
        model = ExtInfoExternalInfomationCreate()
        if include_optional:
            return ExtInfoExternalInfomationCreate(
                external_name = '',
    ...
    def testExtInfoExternalInfomationCreate(self):
        """Test ExtInfoExternalInfomationCreate"""
